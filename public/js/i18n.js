...
const translations = {
  de: {
    ...
    'settings.aiAssistantDesc': 'KI-Assistenten konfigurieren der Benutzern bei Fragen hilft.',
    'settings.aiEnabled': 'Assistent aktiviert',
    'settings.aiUrl': 'Bot-URL',
    'settings.aiUrlPlaceholder': 'https://example.com/chat',
    'settings.aiName': 'Anzeigename',
    'settings.aiNamePlaceholder': 'AI Assistent',
    'settings.aiPosition': 'Button-Position',
    'settings.aiPositionRight': 'Unten rechts',
    'settings.aiPositionLeft': 'Unten links',
    'settings.theme': 'Theme',
    'settings.buttonStyle': 'Button-Stil',
    'settings.glowStrength': 'Glow-Stärke',
    'settings.borderRadius': 'Rundung',
    ...
    // Landing - Terminal
    'landing.terminal': 'Web Terminal',
    'landing.terminalSub': 'SSH-Befehle im Browser ausführen',
    'page.terminal': 'Web Terminal',

    // Terminal
    'terminal.disabled': 'Web Terminal ist nicht aktiviert.',
    'terminal.disabledHint': 'Aktiviere es in der config.js (terminal.enabled: true).',
    'terminal.noTotp': '2FA nicht eingerichtet',
    'terminal.noTotpHint': 'Das Web Terminal erfordert TOTP-2FA. Bitte richte es zuerst in den Einstellungen unter "User" ein.',
    'terminal.goToSettings': 'Zu den Einstellungen',
    'terminal.totpTitle': 'TOTP-Code eingeben',
    'terminal.totpHint': 'Gib den 6-stelligen Code aus deiner Authenticator-App ein.',
    'terminal.verify': 'Verifizieren',
    'terminal.invalidCode': 'Ungültiger Code. Bitte erneut versuchen.',
    'terminal.selectDevice': 'Gerät auswählen',
    'terminal.noDevices': 'Keine Geräte verfügbar.',
    'terminal.disconnect': 'Trennen',
    'terminal.switchDevice': 'Gerät wechseln',
    'terminal.sessionExpired': 'Session abgelaufen. Bitte erneut authentifizieren.',
    ...
    'settings.totpEnabled': 'TOTP aktiv',
    'settings.totpNotConfigured': 'Nicht eingerichtet',
    'settings.totpSetup': 'Einrichten',
    'settings.totpDisable': 'Deaktivieren',
    'settings.totpScanQr': 'QR-Code mit deiner Authenticator-App scannen:',
    'settings.totpManualKey': 'Manueller Schlüssel:',
    'settings.totpEnterCode': 'Code eingeben zum Bestätigen:',
    'settings.totpVerify': 'Verifizieren',
    'settings.totpSuccess': '2FA erfolgreich eingerichtet!',
    'settings.totpDisabled': '2FA deaktiviert.',
    'settings.totpDisableHint': 'Aktuelles Passwort und TOTP-Code eingeben:',
    'settings.totpCodeLabel': 'TOTP-Code',
  ...
  en: {
    ...
    'settings.aiAssistantDesc': 'Configure AI assistant that helps users with questions.',
    'settings.aiEnabled': 'Assistant enabled',
    'settings.aiUrl': 'Bot URL',
    'settings.aiUrlPlaceholder': 'https://example.com/chat',
    'settings.aiName': 'Display name',
    'settings.aiNamePlaceholder': 'AI Assistant',
    'settings.aiPosition': 'Button position',
    'settings.aiPositionRight': 'Bottom right',
    'settings.aiPositionLeft': 'Bottom left',
    'settings.theme': 'Theme',
    ...
    // Landing - Terminal
    'landing.terminal': 'Web Terminal',
    'landing.terminalSub': 'Run SSH commands in the browser',
    'page.terminal': 'Web Terminal',

    // Terminal
    'terminal.disabled': 'Web Terminal is not enabled.',
    'terminal.disabledHint': 'Enable it in config.js (terminal.enabled: true).',
    'terminal.noTotp': '2FA not configured',
    'terminal.noTotpHint': 'The Web Terminal requires TOTP 2FA. Please set it up first in Settings under "User".',
    'terminal.goToSettings': 'Go to Settings',
    'terminal.totpTitle': 'Enter TOTP Code',
    'terminal.totpHint': 'Enter the 6-digit code from your authenticator app.',
    'terminal.verify': 'Verify',
    'terminal.invalidCode': 'Invalid code. Please try again.',
    'terminal.selectDevice': 'Select Device',
    'terminal.noDevices': 'No devices available.',
    'terminal.disconnect': 'Disconnect',
    'terminal.switchDevice': 'Switch Device',
    'terminal.sessionExpired': 'Session expired. Please re-authenticate.',
    ...
    'settings.totpEnabled': 'TOTP active',
    'settings.totpNotConfigured': 'Not configured',
    'settings.totpSetup': 'Set up',
    'settings.totpDisable': 'Disable',
    'settings.totpScanQr': 'Scan the QR code with your authenticator app:',
    'settings.totpManualKey': 'Manual key:',
    'settings.totpEnterCode': 'Enter code to confirm:',
    'settings.totpVerify': 'Verify',
    'settings.totpSuccess': '2FA successfully configured!',
    'settings.totpDisabled': '2FA disabled.',
    'settings.totpDisableHint': 'Enter current password and TOTP code:',
    'settings.totpCodeLabel': 'TOTP Code',
